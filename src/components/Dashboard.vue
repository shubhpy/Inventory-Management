<template>
<div>
    <aside class="sidebar sidebar-icons-right sidebar-icons-boxed h-fullscreen">
    <nav class="sidebar-navigation ps-container ps-theme-default ps-active-y">
        <ul class="menu">
        <li class="menu-category menu-item pr-0">
            <a class="menu-link rounded-left pl-3" routerLinkActive="active">Administrations</a>
        </li>
        <li class="menu-category menu-item pr-0">
            <a class="menu-link rounded-left pl-3"  routerLinkActive="active">Categories</a>
        </li>
        </ul>
    </nav>
    </aside>
    ...
    <div class="topbar-left">
        ...
        <li class="breadcrumb-item"><a routerLinkActive="active">Categories</a></li>
